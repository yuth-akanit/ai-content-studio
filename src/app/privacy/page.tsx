...
const sections = [
  {
    title: '1. Overview',
    body: [
      'AI Content Studio is a web app for businesses to create, schedule, and manage short-form video content. This Privacy Policy explains how we handle information when you use the app and its platform integrations.',
      'If you do not agree with this policy, you should not use AI Content Studio or connect external platform accounts.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'AI Content Studio integrates with YouTube and TikTok via OAuth. OAuth permissions are used to support connected account workflows such as creator info checks, publishing preparation, scheduled publishing, and integration status.',
  ...
  },
  {
    ...
    body: [
      'We use information to operate AI Content Studio, provide content creation and scheduling features, connect authorized platform accounts, troubleshoot errors, secure the service, and respond to support or deletion requests.',
  ...
  },
  {
    title: '5. Sharing',
    body: [
      'We share information only when needed to operate the service, communicate with connected platforms you authorize, comply with legal obligations, or protect the security and reliability of AI Content Studio.',
