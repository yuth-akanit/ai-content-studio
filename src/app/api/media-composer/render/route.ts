...
export async function POST(request: NextRequest) {
  try {
    ...
    const masterVideo = buildMediaComposerMasterVideoRecord(body, rawVideoRender?.ok ? {
      master_video_url: rawVideoRender.final_master_video_url,
      final_master_video_url: rawVideoRender.final_master_video_url,
      ...
      raw_video_asset_id: rawVideoRender.raw_video_asset_id,
      voiceover_asset_id: rawVideoRender.voiceover_asset_id,
      final_master_video_asset_id: rawVideoRender.final_master_video_asset_id,
      generated_voiceover_used: rawVideoRender.generated_voiceover_used,
      voiceover_audio_used: rawVideoRender.voiceover_audio_used,
      audio_expectation: rawVideoRender.audio_expectation,
    } : undefined);
    const distributionPreviewParams = new URLSearchParams({
      master_video_id: masterVideo.id,
      master_video_url: masterVideo.final_master_video_url,
      final_master_video_url: masterVideo.final_master_video_url,
      source_type: masterVideo.source_type,
      source_badge: masterVideo.source_badge,
      source_id: masterVideo.source_id || '',
      raw_video_asset_id: rawVideoRender?.ok ? rawVideoRender.raw_video_asset_id : '',
      voiceover_asset_id: rawVideoRender?.ok ? rawVideoRender.voiceover_asset_id || '' : '',
      final_master_video_asset_id: rawVideoRender?.ok ? rawVideoRender.final_master_video_asset_id : '',
      video_asset_id: rawVideoRender?.ok ? rawVideoRender.final_master_video_asset_id : '',
      asset_role: rawVideoRender?.ok ? rawVideoRender.asset_role : '',
      generated_voiceover_used: String(rawVideoRender?.ok ? rawVideoRender.generated_voiceover_used : false),
      voiceover_audio_used: String(rawVideoRender?.ok ? rawVideoRender.voiceover_audio_used : false),
      audio_mix_mode: rawVideoRender?.ok ? rawVideoRender.audio_mix_mode || '' : '',
      audio_expectation: rawVideoRender?.ok ? rawVideoRender.audio_expectation : '',
    ...
    return NextResponse.json({
      ...
      master_video_record: {
        ...
        final_master_video_url: masterVideo.final_master_video_url,
        raw_video_asset_id: masterVideo.raw_video_asset_id,
        voiceover_asset_id: masterVideo.voiceover_asset_id,
        final_master_video_asset_id: masterVideo.final_master_video_asset_id,
        asset_role: masterVideo.asset_role,
        generated_voiceover_used: masterVideo.generated_voiceover_used,
        voiceover_audio_used: masterVideo.voiceover_audio_used,
        audio_mix_mode: rawVideoRender?.ok ? rawVideoRender.audio_mix_mode : body.audio_mix_mode,
        audio_expectation: masterVideo.audio_expectation,
