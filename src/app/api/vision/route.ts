    ...
    const response = await fetch(`${baseURL}/chat/completions`, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are a visual analysis assistant for a Thai HVAC/refrigeration service business marketing team.
...
Respond in Thai. Be concise but descriptive. Focus on elements useful for creating marketing content.`,
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'วิเคราะห์รูปภาพเหล่านี้เพื่อใช้สร้างคอนเทนต์การตลาด:',
              },
